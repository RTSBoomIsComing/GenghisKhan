...
namespace Khan {
	Renderer::Renderer(HWND hwnd, int width, int height) noexcept
	{
		this->CreateDeviceAndSwapChain(hwnd, width, height);
	...
	void Renderer::CreateDeviceAndSwapChain(HWND hwnd, int width, int height)
	{
	...
	void Renderer::CreateDepthStencilView(int width, int height)
	{
